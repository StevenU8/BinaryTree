...
int main() {
   ...
   // for testing, call your data file something appropriate, e.g., data1.txt
   ...
   //   // test getDepth 
   //   cout << "Depth    --> and:  " << T.getDepth(ppND) << endl;
   ...
   //   }
   //   else         
   //      cout << "Not removed: " << andND << endl;
   //   found = T.remove(notND, p);
   //   if (found) {
   //      cout << "Removed:  " << *p << endl;
   //      delete p;   p = NULL;
   //   }
   //   else         
   //      cout << "Not removed: " << notND << endl;
   //   found = T.remove(sssND, p);
   //   if (found) {
   //      cout << "Removed:  " << *p << endl;
   //      delete p;   p = NULL;
   //   }
   //   else         
   //      cout << "Not removed: " << sssND << endl;
